...
abstract class REST_Controller extends \CI_Controller {
    ...
    /**
     * The LDAP Distinguished Name of the Chauffeur post authentication
     *
     * @var string
     */
    ...
    protected function _perform_ldap_auth($username = '', $password = NULL)
    {
        ...
        {
            log_message('error', 'LDAP Auth: Chauffeur '.$username.' not found in search');
            return FALSE;
        }
        ...
        // Chauffeur found, could not authenticate as user
